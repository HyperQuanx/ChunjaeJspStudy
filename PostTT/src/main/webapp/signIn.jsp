...
<body>
    <div class="login-container">
        ...
        <form action="signIn_Ok.jsp" method="post" name="loginFrm" onsubmit="return validateForm(this);">
            ...
            <span id="userIdMessage" class="validation-message">아이디는 3~10자 소문자 영문이어야 합니다.</span>
    ...
    <script>
        ...
        function validateUserId() {
            if (userIdPattern.test(userIdInput.value)) {
                ...
                userIdMessage.textContent = "아이디는 3~10자 소문자 영문이어야 합니다.";
