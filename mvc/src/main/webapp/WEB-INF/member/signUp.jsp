...
<body>
    <div class="login-container">
        ...
        <form action="<%= request.getContextPath() %>/member/signUp.do" method="post" name="signUpFrm">
	        아이디
		    <input type="text" name="memberId" id="memberId" oninput="validateUserId()" value="" />
		    <span id="userIdMessage" class="validation-message">아이디는 4~10자 소문자 영문 + 숫자를 포함해야 합니다.</span>
