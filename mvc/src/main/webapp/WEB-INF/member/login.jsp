<%@page import="net.fullstack7.utils.CookieManager"%>
...
<body>
    <div class="login-container">
        <h2>로그인 페이지</h2>
        <%
        String idSaveCookieValue = CookieManager.readCookie(request, "idSave");
        %>

        <form action="<%= request.getContextPath() %>/member/login.do" method="post" name="loginFrm" onsubmit="return validateForm(this);">
            아이디
            <input type="text" name="memberId" id="memberId" oninput="validateUserId()" value="<%= idSaveCookieValue != null ? idSaveCookieValue : "" %>" />
            <span id="userIdMessage" class="validation-message">아이디는 4~10자 소문자 영문 + 숫자여야 합니다.</span>
            ...
            <div class="checkbox-container">
                <input type="checkbox" name="idSave" id="idSave" <%= idSaveCookieValue != null ? "checked" : "" %> />
        ...
        <a href="<c:url value='/pagem.do?ove=mb-signUp' />">회원가입</a>
    ...
    <script>
        ...
        const userIdPattern = /^(?=.*[a-z])(?=.*\d)[a-z0-9]{4,10}$/;
        ...
        function validateUserId() {
            if (userIdPattern.test(userIdInput.value)) {
                ...
                userIdMessage.textContent = "아이디는 4~10자 소문자 영문 + 숫자를 포함해야 합니다.";
